require("bufferchad").setup({
  mapping = "<leader>fb", -- Map any key, or set to NONE to disable key mapping
  mark_mapping = "<leader>fm", -- The keybinding to display just the marked buffers
  add_mark_mapping = "<leader>ma", -- The keybinding to add a mark to a buffer
